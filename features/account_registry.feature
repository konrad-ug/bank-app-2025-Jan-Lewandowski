...
Scenario: User is able to update name of already created account
    Given Account registry is empty
    When I create an account using name: "kurt", last name: "cobain", pesel:"95092909876"
    When I update "name" of account with pesel: "95092909876" to "gay"
    Then Account with pesel "95092909876" has "name" equal to "gay"
Scenario: Created account has all fields correctly set
    Given Account registry is empty
    When I create an account using name: "kurt", last name: "cobain", pesel:"89092909246"
    Then Account with pesel "89092909246" exists in registry
    And Account with pesel "89092909246" has "name" equal to "kurt"
    And Account with pesel "89092909246" has "surname" equal to "cobain"
Scenario: User is able to delete created account
    Given Account registry is empty
    When I create an account using name: "parov", last name: "stelar", pesel:"01092909876"
